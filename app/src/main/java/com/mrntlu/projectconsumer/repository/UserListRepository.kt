...
class UserListRepository @Inject constructor(
    ...
    fun incrementTVWatchList(body: IncrementTVSeriesListBody) = networkResponseFlow {
        userListApiService.incrementTVWatchList(body)
    }
    ...
    fun incrementAnimeWatchList(body: IDBody) = networkResponseFlow {
        userListApiService.incrementAnimeWatchList(body)
    }
    ...
    fun incrementGamePlayList(body: IDBody) = networkResponseFlow {
        userListApiService.incrementGamePlayList(body)
    }
